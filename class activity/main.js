...
function add() {
    ...
    /* In this step elements are added and they are seperated by a comma in a single line.*/
}
...
show();
/*This step removes the error from previous step.it adds one task per line.
 With this it also adds a delete button but upon clicking it doesn't work and the screen remains the same.*/
...
/*clicking on delete button it deletses the task*/
